	...
	<div id="content">
		...
		<div class="cart">
			<c:if test="${not empty pageBean.products}">
				<table class='cart-table'>
					...
					<c:forEach items="${pageBean.products}" var="item">
						<tr>
							...
							<td><fmt:formatNumber currencySymbol=" " value="${item.price}"
									type="currency" /></td>
				...
				<form id="order-info" action="newOrder" method='post'>
					<table style="width: 100%;">
						<tr>
							<td colspan="2"><span>Specify the information to
									carry out the order:</span>
							<td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type='text' name='payment_method' required></td>
						</tr>
					</table>
